...
class Member extends CI_Controller
{
	...
	$this->form_validation->set_rules('nama_prestasi', 'nama prestasi', 'trim');
	...
	$this->form_validation->set_rules('id_peserta', 'nama peserta', 'trim');
	$this->form_validation->set_rules('id_prestasi', 'detail prestasi', 'trim');
