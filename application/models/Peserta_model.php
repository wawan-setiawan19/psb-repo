...
class Peserta_model extends CI_Model
{
    ...
    // datatables
    function json() {      
        $this->datatables->select('id_peserta,no_pendaftaran,nama_peserta,jalur.id_jalur,jalur');        
        // $this->datatables->select('id_peserta,no_pendaftaran,tanggal_daftar,nama_peserta,jenis_kelamin,nisn,nik,tempat_lahir,tanggal_lahir,no_registrasi_akta_lahir,agama,aktivasi,berkebutuhan_khusus,alamat,rt,rw,nama_dusun,nama_kelurahan,peserta.kecamatan,kode_pos,latitude,longitude,tempat_tinggal,moda_transportasi,no_kks,anak_ke,penerima_kps_pkh,no_kps_pkh,penerima_kip,no_kip,nama_tertera_di_kip,terima_fisik_kartu_kip,nama_ayah,nik_ayah,tahun_lahir_ayah,pendidikan_ayah,pekerjaan_ayah,penghasilan_bulanan_ayah,berkebutuhan_khusus_ayah,nama_ibu,nik_ibu,tahun_lahir_ibu,pendidikan_ibu,pekerjaan_ibu,penghasilan_bulanan_ibu,berkebutuhan_khusus_ibu,nama_wali,nik_wali,tahun_lahir_wali,pendidikan_wali,pekerjaan_wali,penghasilan_bulanan_wali,no_telepon_rumah,nomor_hp,email,jenis_ekstrakurikuler,tinggi_badan,berat_badan,jumlah_saudara_kandung,pilihan_dua,no_un,no_seri_ijazah,no_seri_skhu,nilai_rapor,nilai_usbn,nilai_unbk_unkp,status,aktivasi,status_hasil,status_daftar_ulang,id_users,asal_sekolah,jalur.id_jalur,jalur,tahunpelajaran.id_tahun,tahun_pelajaran,status_tahun');        
    ...
    {
        $this->db->select('id_peserta,no_pendaftaran,tanggal_daftar,nama_peserta,jenis_kelamin,nisn,nik,tempat_lahir,tanggal_lahir,no_registrasi_akta_lahir,agama,kewarganegaraan,berkebutuhan_khusus,alamat,rt,rw,nama_dusun,nama_kelurahan,peserta.kecamatan,kode_pos,latitude,longitude,tempat_tinggal,moda_transportasi,no_kks,anak_ke,penerima_kps_pkh,no_kps_pkh,penerima_kip,no_kip,nama_tertera_di_kip,terima_fisik_kartu_kip,nama_ayah,nik_ayah,tahun_lahir_ayah,pendidikan_ayah,pekerjaan_ayah,penghasilan_bulanan_ayah,berkebutuhan_khusus_ayah,nama_ibu,nik_ibu,tahun_lahir_ibu,pendidikan_ibu,pekerjaan_ibu,penghasilan_bulanan_ibu,berkebutuhan_khusus_ibu,nama_wali,nik_wali,tahun_lahir_wali,pendidikan_wali,pekerjaan_wali,penghasilan_bulanan_wali,no_telepon_rumah,nomor_hp,email,jenis_ekstrakurikuler,tinggi_badan,berat_badan,jumlah_saudara_kandung,pilihan_dua,no_un,no_seri_ijazah,no_seri_skhu,nilai_rapor,nilai_usbn,nilai_unbk_unkp,status,aktivasi,status_hasil,status_daftar_ulang,id_users,sekolah.id_sekolah,asal_sekolah,jalur.id_jalur,jalur,persentase,tahunpelajaran.id_tahun,tahun_pelajaran,kuota,status_tahun,count(jalur.id_jalur) as countjalur,pilihan_sekolah_lain,catatan');
        $this->db->join('sekolah',$this->table.".id_sekolah = sekolah.id_sekolah"); 
        $this->db->join('jalur', $this->table.".id_jalur = jalur.id_jalur");
        // $this->db->join('jurusan', $this->table.".id_jurusan = jurusan.id_jurusan");
        $this->db->join('tahunpelajaran', $this->table.".id_tahun = tahunpelajaran.id_tahun");
    ...
    {
        $this->db->select('id_peserta,no_pendaftaran,tanggal_daftar,nama_peserta,jenis_kelamin,nisn,nik,tempat_lahir,tanggal_lahir,no_registrasi_akta_lahir,agama,kewarganegaraan,berkebutuhan_khusus,alamat,rt,rw,nama_dusun,nama_kelurahan,peserta.kecamatan,kode_pos,latitude,longitude,tempat_tinggal,moda_transportasi,no_kks,anak_ke,penerima_kps_pkh,no_kps_pkh,penerima_kip,no_kip,nama_tertera_di_kip,terima_fisik_kartu_kip,nama_ayah,nik_ayah,tahun_lahir_ayah,pendidikan_ayah,pekerjaan_ayah,penghasilan_bulanan_ayah,berkebutuhan_khusus_ayah,nama_ibu,nik_ibu,tahun_lahir_ibu,pendidikan_ibu,pekerjaan_ibu,penghasilan_bulanan_ibu,berkebutuhan_khusus_ibu,nama_wali,nik_wali,tahun_lahir_wali,pendidikan_wali,pekerjaan_wali,penghasilan_bulanan_wali,no_telepon_rumah,nomor_hp,email,jenis_ekstrakurikuler,tinggi_badan,berat_badan,jumlah_saudara_kandung,pilihan_dua,no_un,no_seri_ijazah,no_seri_skhu,nilai_rapor,nilai_usbn,nilai_unbk_unkp,status,aktivasi,status_hasil,status_daftar_ulang,id_users,qrcode,sekolah.id_sekolah,asal_sekolah,jalur.id_jalur,jalur,tahunpelajaran.id_tahun,tahun_pelajaran,tanggal_mulai_daftar_ulang,tanggal_selesai_daftar_ulang,tanggal_pengumuman,status_tahun,pilihan_sekolah_lain,catatan');
        $this->db->join('sekolah',$this->table.".id_sekolah = sekolah.id_sekolah"); 
        $this->db->join('jalur', $this->table.".id_jalur = jalur.id_jalur");
        // $this->db->join('jurusan', $this->table.".id_jurusan = jurusan.id_jurusan");
        $this->db->join('tahunpelajaran', $this->table.".id_tahun = tahunpelajaran.id_tahun");               
    ...
    function get_id($id)
    {
        $this->db->select('id_peserta,nama_peserta,status,aktivasi,status_hasil,status_daftar_ulang,id_users,catatan');        
        $this->db->where($this->id, $id);
        return $this->db->get($this->table)->row();
    }          
    ...
    function biodata_diri(){
        ...
        $this->db->select('id_peserta,nama_peserta,jenis_kelamin, id_jalur');
        // $this->db->join('jalur', 'peserta.id_jalur = jalur.id_jalur');
    ...
    {
        $user = $this->ion_auth->user()->row();  
        $this->db->select('id_peserta,no_pendaftaran,status,aktivasi,status_hasil,status_daftar_ulang,id_users,catatan');
        $this->db->where('id_users', $user->id);
        return $query = $this->db->get($this->table)->row();
    }  
...
// ------------------------------ END DASHBOARD ---------------------    
    ...
    function get_aktivasi($id,$hasil)
    {
        $hasil=$this->db->query("UPDATE peserta SET aktivasi='$hasil' WHERE id_peserta='$id'");
        return $hasil;       
    } 
