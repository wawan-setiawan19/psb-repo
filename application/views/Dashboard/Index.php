    ...
    <div class="box box-info">
      <div class="box-header <?= $this->config->item('header')?>">
        <!-- <img src="<?php echo base_url('assets/dist/img/nenemowhite.png') ?>" width="55" height="25"> -->
          <h3 class="box-title">PSB <?php echo strtoupper($pengaturan->nama_sekolah) ?></h3>
...
<?php } else { ?>
  ...
  if ($user->activation_code !== '200') { ?>
    ...
    <?php } else { ?>
      <div class="jumbotron well well-lg bg-green rounded">
      <div class="container">
        <h1>Akun anda belum diaktivasi</h1>
        <!-- <a href="activation/request">Request</a> -->
        <button class="btn btn-primary btn-lg well" id="requestActivation" data-toggle="modal" data-target="#modalRequestActivation" role="button"><h4>Minta aktivasi</h2></button>
      </div>
    </div>
  <?php }?>

    <div class="modal fade" id="modalRequestActivation" tabindex="-1" role="dialog" aria-labelledby="modalRequestActivationLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h5 class="modal-title" id="modalRequestActivationLabel">Formulir Pengajuan Aktivasi</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
              <span aria-hidden="true">&times;</span>
            </button>
          </div>
          <div class="modal-body">
            <form action="dashboard/requestActivation" method="POST">
