...
<!-- end pilihan jurusan -->                                                    
                ...
                <!-- star nilai -->
                      <?php if ($formulir->nilai_usbn=='Ya' || $formulir->nilai_rapor=='Ya' || $formulir->nilai_unbk_unkp=='Ya'){ ?> 
                          ...
                          <div class="form-group">
                                <label for="varchar">Nilai Rata-rata Rapor/SKL <span style="color:red;">*</span> <?php echo form_error('nilai_rapor') ?></label>
                ...
                <!-- end nilai -->  
                          ...
                          <button type="submit" class="<?= $this->config->item('botton')?>">Ajukan Formulir Pendaftaran</button>                                                               
            </form>
          </div>
    </div>
