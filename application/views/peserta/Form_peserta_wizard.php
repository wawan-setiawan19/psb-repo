    ...
    <div class="box">
          ...
          <div class="box-body">
            <form action="<?php echo $action; ?>" role="form" method="post" accept-charset="utf-8">
              ...
              <div id="smartwizard">
                  <ul>
                      <li><a href="#step-1">Step 1<br /><small>Ketentuan</small></a></li>
                      <li><a href="#step-2">Step 2<br /><small>Data Registrasi</small></a></li>
                      <li><a href="#step-3">Step 3<br /><small>Data Pribadi</small></a></li>
                      <li><a href="#step-4">Step 4<br /><small>Data Orangtua/Wali</small></a></li>
                      <li><a href="#step-5">Step 5<br /><small>Data Priodik</small></a></li>
                  <?php if ($formulir->nilai_usbn=='Ya' || $formulir->nilai_rapor=='Ya' || $formulir->nilai_unbk_unkp=='Ya'){ ?>       
                      <li><a href="#step-6">Step 6<br /><small>Data Nilai</small></a></li>
                      <li><a href="#step-7">Step 7<br /><small>Konfirmasi Data</small></a></li>
                  <?php } else { ?>   
                      <li><a href="#step-7">Step 6<br /><small>Konfirmasi Data</small></a></li>
                  <?php } ?>                      
                  </ul>
                  <div>
                      <div id="step-1">
                          <h2>Ketentuan PPDB</h2>
