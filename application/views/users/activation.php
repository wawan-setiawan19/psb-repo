            ...
            <form id="myform" method="post" onsubmit="return false">
                <div class="row" style="margin-bottom: 10px">
                    <div class="col-xs-4 col-md-4">                      
                        <button id="aktivasi" class="btn btn-primary btn-flat" type="submit"><i class="fa fa-check"></i><span class="hidden-xs">&nbsp;&nbsp;Aktivasi Data Terpilih</span></button>
                        <button id="deaktivasi" class="btn btn-danger btn-flat" type="submit"><i class="fa fa-ban"></i><span class="hidden-xs">&nbsp;&nbsp;Deaktivasi Data Terpilih</span></button>
                    </div>
                ...
                <div class="table-responsive">
                    <table class="table table-bordered table-striped" id="mytableActivation" style="width:100%">
                        <thead>
                            <tr>
                                <th width=""></th>
                                <th width="10px">No</th>
